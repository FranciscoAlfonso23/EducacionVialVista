...
export default function Plataforma() {
    ...
    const [pathImage, setPathImage] = useState("https://eduvial-server.herokuapp.com/upload.png")
    ...
    const sendImage = (e) => {
        ...
        UploadService.sendDocument(name, descripcion, file).then((result) => {
            ...
            UploadService.mostrarDocumentos().then((result) => {
                setData(result.data)
                handleClick()
                setPathImage("https://eduvial-server.herokuapp.com/upload.png")
            })
        })
    }
    ...
    const eliminar = (id) => {
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    UploadService.deleteDocument(id).then((result) => {
            ...
            <div className="content">
                <Row>
                    <Col xs={12}>
                        <Card>
                            <CardHeader>
                                <CardTitle tag="h4">Tabla de Recursos PDF</CardTitle>
                            </CardHeader>
                            <CardBody>
                                <Table responsive>
